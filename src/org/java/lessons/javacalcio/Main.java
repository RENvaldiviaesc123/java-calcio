...
public class Main {
    ...
    private static final String [] NOMI_COGNOMI_ALLENATORI = {
            "Alice Adams", "Bob Baker", "Charlie Carter", "David Clark", "Emma Davis",
            "Frank Evans", "Grace Foster", "Hannah Green", "Ivy Harris", "Jack Hill",
            "Katie Jackson", "Liam Johnson", "Mia Jones", "Noah King", "Olivia Lee",
            "Parker Lewis", "Quinn Martinez", "Ryan Miller", "Sophia Mitchell", "Tyler Moore"
    };
    private static final String[] ruoliGiocatori  = {"Portiere", "Diffensore", "Centrocampista", "Attacante", "Capitano"};
